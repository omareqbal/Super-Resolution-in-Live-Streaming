...
% size_prefilt_Y_1 = size(prefilt_Y{1}, 1);
% size_prefilt_Y_2 = size(prefilt_Y{1}, 2);
...
for t = 1:N_frames
    ...
    % recon_inter{t} = zeros(size_prefilt_Y_1, size_prefilt_Y_2);
    % inter_mask{t} = zeros(size_prefilt_Y_1, size_prefilt_Y_2);
    % mv_x_map{t} = zeros(size_prefilt_Y_1, size_prefilt_Y_2);
    % mv_y_map{t} = zeros(size_prefilt_Y_1, size_prefilt_Y_2);
